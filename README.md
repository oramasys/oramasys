...
| `ORAMA_AUTH_TWITTER_X` + `ORAMA_TWITTER_CLIENT_ID` | X/Twitter OAuth (Authlib, PKCE-ready); HTTP attest needs `ORAMA_TWITTER_ARTIFACT_SECRET` (≥32 UTF-8 bytes) + `X-Twitter-OAuth-Artifact` |
